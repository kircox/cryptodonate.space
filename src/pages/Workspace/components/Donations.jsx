              ...
              >
                ...
                >
                  ...
                  <Flex justifyContent="center">
                    <Text h3>You haven't recived donated yet</Text>
                  </Flex>
                  <Spacer y={1} />

                  <Flex justifyContent="center">
                    <Text color="warning" h5>
                      Don't forget to share this link with your followers
                    </Text>
                  </Flex>
                  <Flex
                    direction={"column"}
                ...
                >
                  <Spacer y={1} />
                  <Flex justifyContent="center">
                    <Text h3>Donation alerts in OBS Studio</Text>
                  </Flex>
                  <Spacer y={0.8} />
                  ...
                  <React.Fragment key={doc.data().id}>
                    ...
                    >
                      ...
                      <Flex justifyContent="end" alignItems={"center"}>
                        ...
                        >
                          {format(convertDate(doc.data().time), "mediumDate")}
                        </Text>
                        <Spacer />
                        <Text
                          css={{
                        ...
                        >
                          {format(convertDate(doc.data().time), "shortTime")}
                        </Text>
                        <Spacer />
                      </Flex>
                    </Container>
